...
# Étape 3: Reconstruction de l'image (si nécessaire)
log "🏗️  3. Reconstruction de l'image..."
...
log "🆙 4. Démarrage du nouveau service..."
...
# Étape 5: Health check du nouveau service
log "🏥 5. Vérification de la santé du nouveau service..."
if ! check_health; then
