...
def test_email_send():
    ...
    # Email de test
    test_email = "pedininonsse@gmail.com"  # Votre email
    ...
    try:
        ...
        message['Subject'] = "Test Email - Datalys Consulting"
...
if __name__ == "__main__":
    print("Test Email - Datalys Consulting")
    print("=" * 50)
    ...
    if smtp_ok and email_ok:
        ...
        print("Vérifiez la configuration SMTP dans .env.local") 